...
-type export_trace_service_request() ::
      #{resource_spans          => [resource_spans()] % = 1
       }.

-type export_trace_service_response() ::
      #{partial_success         => export_trace_partial_success() % = 1
       }.

-type export_trace_partial_success() ::
      #{rejected_spans          => integer(),       % = 1, 64 bits
...
-type link() ::
      #{trace_id                => iodata(),        % = 1
        ...
        flags                   => non_neg_integer() % = 6, 32 bits
       }.
...
-type span() ::
      #{trace_id                => iodata(),        % = 1
        ...
        flags                   => non_neg_integer(), % = 16, 32 bits
        name                    => iodata(),        % = 5
...
-type status() ::
      #{message                 => iodata(),        % = 2
        code                    => 'STATUS_CODE_UNSET' | 'STATUS_CODE_OK' | 'STATUS_CODE_ERROR' | integer() % = 3, enum status.StatusCode
       }.
...
-spec encode_msg(export_trace_service_request() | export_trace_service_response() | export_trace_partial_success() | traces_data() | resource_spans() | scope_spans() | event() | link() | span() | status() | any_value() | array_value() | key_value_list() | key_value() | instrumentation_scope() | resource(), atom()) -> binary().
encode_msg(Msg, MsgName) when is_atom(MsgName) ->
    encode_msg(Msg, MsgName, []).

-spec encode_msg(export_trace_service_request() | export_trace_service_response() | export_trace_partial_success() | traces_data() | resource_spans() | scope_spans() | event() | link() | span() | status() | any_value() | array_value() | key_value_list() | key_value() | instrumentation_scope() | resource(), atom(), list()) -> binary().
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        ...
        export_trace_partial_success ->
            encode_msg_export_trace_partial_success(id(Msg,
                                                       TrUserData),
                                                    TrUserData);
        traces_data ->
            encode_msg_traces_data(id(Msg, TrUserData), TrUserData);
        resource_spans ->
            encode_msg_resource_spans(id(Msg, TrUserData),
                                      TrUserData);
        scope_spans ->
            encode_msg_scope_spans(id(Msg, TrUserData), TrUserData);
        event ->
...
encode_msg_export_trace_service_response(Msg,
                                         TrUserData) ->
    encode_msg_export_trace_service_response(Msg,
                                             <<>>,
                                             TrUserData).
...
encode_msg_export_trace_service_response(#{} = M, Bin,
                                         TrUserData) ->
    case M of
        #{partial_success := F1} ->
            begin
                ...
                if TrF1 =:= undefined -> Bin;
                   true ->
                       e_mfield_export_trace_service_response_partial_success(TrF1,
                                                                              <<Bin/binary,
                                                                                10>>,
                                                                              TrUserData)
                end
...
encode_msg_export_trace_partial_success(Msg,
                                        TrUserData) ->
    encode_msg_export_trace_partial_success(Msg,
                                            <<>>,
                                            TrUserData).
...
encode_msg_export_trace_partial_success(#{} = M, Bin,
                                        TrUserData) ->
    B1 = case M of
             #{rejected_spans := F1} ->
                 begin
...
encode_msg_traces_data(Msg, TrUserData) ->
    encode_msg_traces_data(Msg, <<>>, TrUserData).
...
encode_msg_traces_data(#{} = M, Bin, TrUserData) ->
    case M of
        #{resource_spans := F1} ->
            ...
            if TrF1 == [] -> Bin;
               true ->
                   e_field_traces_data_resource_spans(TrF1,
                                                      Bin,
                                                      TrUserData)
            end;
        _ -> Bin
...
encode_msg_resource_spans(#{} = M, Bin, TrUserData) ->
    ...
    B2 = case M of
             #{scope_spans := F2} ->
                 ...
                 if TrF2 == [] -> B1;
                    true ->
                        e_field_resource_spans_scope_spans(TrF2, B1, TrUserData)
                 end;
             _ -> B1
         end,
    case M of
...
encode_msg_scope_spans(Msg, TrUserData) ->
    encode_msg_scope_spans(Msg, <<>>, TrUserData).
    ...
    B1 = case M of
             #{scope := F1} ->
                 begin
                     ...
                     if TrF1 =:= undefined -> Bin;
                        true ->
                            e_mfield_scope_spans_scope(TrF1,
                                                       <<Bin/binary, 10>>,
                                                       TrUserData)
                     end
                 end;
    ...
    case M of
        #{flags := F6} ->
            begin
                ...
                if TrF6 =:= 0 -> B5;
                   true ->
                       e_type_fixed32(TrF6, <<B5/binary, 53>>, TrUserData)
                end
            end;
        _ -> B5
    end.
             ...
             #{name := F6} ->
                 begin
                     ...
                     case is_empty_string(TrF6) of
                         true -> B5;
                         false ->
                             e_type_string(TrF6, <<B5/binary, 42>>, TrUserData)
                     end
                 end;
             _ -> B5
         end,
    ...
    B8 = case M of
             #{start_time_unix_nano := F8} ->
                 begin
                     ...
                     if TrF8 =:= 0 -> B7;
                        true ->
                            e_type_fixed64(TrF8, <<B7/binary, 57>>, TrUserData)
                     end
                 end;
             _ -> B7
         end,
    B9 = case M of
             #{end_time_unix_nano := F9} ->
                 begin
                     ...
                     if TrF9 =:= 0 -> B8;
                        true ->
                            e_type_fixed64(TrF9, <<B8/binary, 65>>, TrUserData)
                     end
                 end;
             _ -> B8
         end,
    ...
    B15 = case M of
              #{dropped_links_count := F15} ->
                  begin
                      ...
                      if TrF15 =:= 0 -> B14;
                         true ->
                             e_varint(TrF15, <<B14/binary, 112>>, TrUserData)
                      end
                  end;
              _ -> B14
          end,
...
e_mfield_export_trace_service_response_partial_success(Msg,
                                                       Bin, TrUserData) ->
    SubBin = encode_msg_export_trace_partial_success(Msg,
                                                     <<>>,
                                                     TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_mfield_traces_data_resource_spans(Msg, Bin,
                                    TrUserData) ->
    SubBin = encode_msg_resource_spans(Msg,
                                       <<>>,
                                       TrUserData),
...
e_field_traces_data_resource_spans([Elem | Rest], Bin,
                                   TrUserData) ->
    Bin2 = <<Bin/binary, 10>>,
    Bin3 = e_mfield_traces_data_resource_spans(id(Elem,
                                                  TrUserData),
                                               Bin2,
                                               TrUserData),
    e_field_traces_data_resource_spans(Rest,
                                       Bin3,
                                       TrUserData);
e_field_traces_data_resource_spans([], Bin,
                                   _TrUserData) ->
    Bin.
...
e_mfield_resource_spans_scope_spans(Msg, Bin,
                                    TrUserData) ->
    SubBin = encode_msg_scope_spans(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_resource_spans_scope_spans([Elem | Rest], Bin,
                                   TrUserData) ->
    Bin2 = <<Bin/binary, 18>>,
    Bin3 = e_mfield_resource_spans_scope_spans(id(Elem,
                                                  TrUserData),
                                               Bin2,
                                               TrUserData),
    e_field_resource_spans_scope_spans(Rest,
                                       Bin3,
                                       TrUserData);
e_field_resource_spans_scope_spans([], Bin,
                                   _TrUserData) ->
    Bin.
...
e_field_scope_spans_spans([Elem | Rest], Bin,
                          TrUserData) ->
    Bin2 = <<Bin/binary, 18>>,
    Bin3 = e_mfield_scope_spans_spans(id(Elem, TrUserData),
                                      Bin2,
                                      TrUserData),
...
'e_enum_span.SpanKind'('SPAN_KIND_UNSPECIFIED', Bin,
                       _TrUserData) ->
    <<Bin/binary, 0>>;
'e_enum_span.SpanKind'('SPAN_KIND_INTERNAL', Bin,
                       _TrUserData) ->
    <<Bin/binary, 1>>;
'e_enum_span.SpanKind'('SPAN_KIND_SERVER', Bin,
                       _TrUserData) ->
    <<Bin/binary, 2>>;
'e_enum_span.SpanKind'('SPAN_KIND_CLIENT', Bin,
                       _TrUserData) ->
    <<Bin/binary, 3>>;
'e_enum_span.SpanKind'('SPAN_KIND_PRODUCER', Bin,
                       _TrUserData) ->
    <<Bin/binary, 4>>;
'e_enum_span.SpanKind'('SPAN_KIND_CONSUMER', Bin,
                       _TrUserData) ->
    <<Bin/binary, 5>>;
'e_enum_span.SpanKind'(V, Bin, _TrUserData) ->
    e_varint(V, Bin).

'e_enum_status.StatusCode'('STATUS_CODE_UNSET', Bin,
                           _TrUserData) ->
    <<Bin/binary, 0>>;
'e_enum_status.StatusCode'('STATUS_CODE_OK', Bin,
                           _TrUserData) ->
    <<Bin/binary, 1>>;
'e_enum_status.StatusCode'('STATUS_CODE_ERROR', Bin,
                           _TrUserData) ->
    <<Bin/binary, 2>>;
...
decode_msg_2_doit(export_trace_service_response, Bin,
    ...
    id(decode_msg_export_trace_service_response(Bin,
                                                TrUserData),
       TrUserData);
decode_msg_2_doit(export_trace_partial_success, Bin,
                  TrUserData) ->
    id(decode_msg_export_trace_partial_success(Bin,
                                               TrUserData),
       TrUserData);
decode_msg_2_doit(traces_data, Bin, TrUserData) ->
    id(decode_msg_traces_data(Bin, TrUserData), TrUserData);
decode_msg_2_doit(resource_spans, Bin, TrUserData) ->
    id(decode_msg_resource_spans(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(scope_spans, Bin, TrUserData) ->
    id(decode_msg_scope_spans(Bin, TrUserData), TrUserData);
...
dfp_read_field_def_export_trace_service_response(<<10,
                                                   Rest/binary>>,
                                                 Z1, Z2, F@_1, TrUserData) ->
    d_field_export_trace_service_response_partial_success(Rest,
                                                          Z1,
                                                          Z2,
                                                          F@_1,
                                                          TrUserData);
...
d_field_export_trace_service_response_partial_success(<<1:1,
                                                        X:7, Rest/binary>>,
                                                      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_export_trace_service_response_partial_success(Rest,
                                                          ...
                                                          F@_1,
                                                          TrUserData);
d_field_export_trace_service_response_partial_success(<<0:1,
                                                        X:7, Rest/binary>>,
                                                      N, Acc, Prev,
                                                      TrUserData) ->
    {NewFValue, RestF} = begin
                             Len = X bsl N + Acc,
                             <<Bs:Len/binary, Rest2/binary>> = Rest,
                             {id(decode_msg_export_trace_partial_success(Bs,
                                                                         TrUserData),
                                 TrUserData),
                              Rest2}
                         end,
    dfp_read_field_def_export_trace_service_response(RestF,
                                                     ...
                                                     if Prev == '$undef' ->
                                                            NewFValue;
                                                        true ->
                                                            merge_msg_export_trace_partial_success(Prev,
                                                                                                   NewFValue,
                                                                                                   TrUserData)
                                                     end,
                                                     TrUserData).
...
decode_msg_export_trace_partial_success(Bin,
                                        TrUserData) ->
    dfp_read_field_def_export_trace_partial_success(Bin,
                                                    0,
                                                    0,
                                                    id(0, TrUserData),
                                                    id(<<>>, TrUserData),
...
dfp_read_field_def_export_trace_partial_success(<<8,
                                                  Rest/binary>>,
                                                Z1, Z2, F@_1, F@_2,
                                                TrUserData) ->
    d_field_export_trace_partial_success_rejected_spans(Rest,
                                                        Z1,
                                                        Z2,
                                                        F@_1,
                                                        F@_2,
                                                        TrUserData);
dfp_read_field_def_export_trace_partial_success(<<18,
                                                  Rest/binary>>,
                                                Z1, Z2, F@_1, F@_2,
                                                TrUserData) ->
    d_field_export_trace_partial_success_error_message(Rest,
                                                       Z1,
                                                       Z2,
                                                       F@_1,
                                                       F@_2,
                                                       TrUserData);
dfp_read_field_def_export_trace_partial_success(<<>>, 0,
                                                0, F@_1, F@_2, _) ->
    #{rejected_spans => F@_1, error_message => F@_2};
dfp_read_field_def_export_trace_partial_success(Other,
                                                Z1, Z2, F@_1, F@_2,
                                                TrUserData) ->
    dg_read_field_def_export_trace_partial_success(Other,
                                                   Z1,
                                                   Z2,
                                                   F@_1,
                                                   F@_2,
...
dg_read_field_def_export_trace_partial_success(<<1:1,
                                                 X:7, Rest/binary>>,
                                               N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_export_trace_partial_success(Rest,
                                                   N + 7,
                                                   X bsl N + Acc,
                                                   F@_1,
                                                   F@_2,
                                                   TrUserData);
dg_read_field_def_export_trace_partial_success(<<0:1,
                                                 X:7, Rest/binary>>,
                                               N, Acc, F@_1, F@_2,
                                               TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    skip_varint_export_trace_partial_success(Rest,
                                                             0,
                                                             0,
                                                             F@_1,
                                                             F@_2,
                                                             TrUserData);
                1 ->
                    skip_64_export_trace_partial_success(Rest,
                                                         0,
                                                         0,
                                                         F@_1,
                                                         F@_2,
                                                         TrUserData);
                2 ->
                    skip_length_delimited_export_trace_partial_success(Rest,
                                                                       0,
                                                                       0,
                                                                       F@_1,
                                                                       F@_2,
                                                                       TrUserData);
                3 ->
                    skip_group_export_trace_partial_success(Rest,
                                                            Key bsr 3,
                                                            0,
                                                            F@_1,
                                                            F@_2,
                                                            TrUserData);
                5 ->
                    skip_32_export_trace_partial_success(Rest,
                                                         0,
                                                         0,
                                                         F@_1,
                                                         F@_2,
...
dg_read_field_def_export_trace_partial_success(<<>>, 0,
                                               0, F@_1, F@_2, _) ->
    #{rejected_spans => F@_1, error_message => F@_2}.

d_field_export_trace_partial_success_rejected_spans(<<1:1,
                                                      X:7, Rest/binary>>,
                                                    N, Acc, F@_1, F@_2,
                                                    TrUserData)
    when N < 57 ->
    d_field_export_trace_partial_success_rejected_spans(Rest,
                                                        ...
                                                        F@_2,
                                                        TrUserData);
d_field_export_trace_partial_success_rejected_spans(<<0:1,
                                                      X:7, Rest/binary>>,
                                                    N, Acc, _, F@_2,
                                                    TrUserData) ->
    {NewFValue, RestF} = {begin
                          ...
                          Rest},
    dfp_read_field_def_export_trace_partial_success(RestF,
                                                    0,
                                                    0,
                                                    NewFValue,
                                                    F@_2,
...
d_field_export_trace_partial_success_error_message(<<1:1,
                                                     X:7, Rest/binary>>,
                                                   N, Acc, F@_1, F@_2,
                                                   TrUserData)
    when N < 57 ->
    d_field_export_trace_partial_success_error_message(Rest,
                                                       ...
                                                       F@_2,
                                                       TrUserData);
d_field_export_trace_partial_success_error_message(<<0:1,
                                                     X:7, Rest/binary>>,
                                                   N, Acc, F@_1, _,
                                                   TrUserData) ->
    {NewFValue, RestF} = begin
...
skip_varint_export_trace_partial_success(<<1:1, _:7,
                                           Rest/binary>>,
    ...
    skip_varint_export_trace_partial_success(Rest,
                                             ...
                                             F@_2,
                                             TrUserData);
skip_varint_export_trace_partial_success(<<0:1, _:7,
                                           Rest/binary>>,
                                         Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_export_trace_partial_success(Rest,
                                                    Z1,
                                                    Z2,
                                                    F@_1,
                                                    F@_2,
...
skip_length_delimited_export_trace_partial_success(<<1:1,
                                                     X:7, Rest/binary>>,
                                                   N, Acc, F@_1, F@_2,
                                                   TrUserData)
    when N < 57 ->
    skip_length_delimited_export_trace_partial_success(Rest,
                                                       ...
                                                       F@_2,
                                                       TrUserData);
skip_length_delimited_export_trace_partial_success(<<0:1,
                                                     X:7, Rest/binary>>,
                                                   N, Acc, F@_1, F@_2,
                                                   TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_export_trace_partial_success(Rest2,
                                                    0,
                                                    0,
                                                    F@_1,
                                                    F@_2,
...
skip_group_export_trace_partial_success(Bin, FNum, Z2,
...
skip_32_export_trace_partial_success(<<_:32,
                                       Rest/binary>>,
                                     Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_export_trace_partial_success(Rest,
                                                    Z1,
...
skip_64_export_trace_partial_success(<<_:64,
                                       Rest/binary>>,
                                     Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_export_trace_partial_success(Rest,
                                                    Z1,
...
decode_msg_traces_data(Bin, TrUserData) ->
    dfp_read_field_def_traces_data(Bin,
                                   0,
                                   0,
                                   id([], TrUserData),
                                   TrUserData).

dfp_read_field_def_traces_data(<<10, Rest/binary>>, Z1,
                               Z2, F@_1, TrUserData) ->
    d_field_traces_data_resource_spans(Rest,
                                       Z1,
                                       Z2,
                                       F@_1,
                                       TrUserData);
dfp_read_field_def_traces_data(<<>>, 0, 0, R1,
                               TrUserData) ->
    S1 = #{},
    if R1 == '$undef' -> S1;
       true ->
...
dfp_read_field_def_traces_data(Other, Z1, Z2, F@_1,
                               TrUserData) ->
    dg_read_field_def_traces_data(Other,
                                  Z1,
                                  Z2,
                                  F@_1,
                                  TrUserData).

dg_read_field_def_traces_data(<<1:1, X:7, Rest/binary>>,
                              N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_traces_data(Rest,
                                  N + 7,
                                  X bsl N + Acc,
                                  F@_1,
                                  TrUserData);
dg_read_field_def_traces_data(<<0:1, X:7, Rest/binary>>,
                              N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        10 ->
        ...
        _ ->
            case Key band 7 of
                0 ->
                    skip_varint_traces_data(Rest, 0, 0, F@_1, TrUserData);
                1 -> skip_64_traces_data(Rest, 0, 0, F@_1, TrUserData);
                2 ->
                    skip_length_delimited_traces_data(Rest,
                                                      0,
                                                      0,
                                                      F@_1,
                                                      TrUserData);
                3 ->
                    skip_group_traces_data(Rest,
                                           Key bsr 3,
                                           0,
                                           F@_1,
                                           TrUserData);
                5 -> skip_32_traces_data(Rest, 0, 0, F@_1, TrUserData)
            end
    end;
dg_read_field_def_traces_data(<<>>, 0, 0, R1,
                              TrUserData) ->
    S1 = #{},
    if R1 == '$undef' -> S1;
       true ->
...
d_field_traces_data_resource_spans(<<1:1, X:7,
                                     Rest/binary>>,
                                   N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_traces_data_resource_spans(Rest,
                                       ...
                                       F@_1,
                                       TrUserData);
d_field_traces_data_resource_spans(<<0:1, X:7,
                                     Rest/binary>>,
                                   N, Acc, Prev, TrUserData) ->
    {NewFValue, RestF} = begin
                             Len = X bsl N + Acc,
    ...
    dfp_read_field_def_traces_data(RestF,
                                   0,
                                   0,
                                   cons(NewFValue, Prev, TrUserData),
                                   TrUserData).

skip_varint_traces_data(<<1:1, _:7, Rest/binary>>, Z1,
                        Z2, F@_1, TrUserData) ->
    skip_varint_traces_data(Rest, Z1, Z2, F@_1, TrUserData);
skip_varint_traces_data(<<0:1, _:7, Rest/binary>>, Z1,
                        Z2, F@_1, TrUserData) ->
    dfp_read_field_def_traces_data(Rest,
                                   Z1,
                                   Z2,
                                   F@_1,
                                   TrUserData).

skip_length_delimited_traces_data(<<1:1, X:7,
                                    Rest/binary>>,
                                  N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_traces_data(Rest,
                                      ...
                                      F@_1,
                                      TrUserData);
skip_length_delimited_traces_data(<<0:1, X:7,
                                    Rest/binary>>,
                                  N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_traces_data(Rest2,
                                   0,
                                   0,
                                   F@_1,
                                   TrUserData).

skip_group_traces_data(Bin, FNum, Z2, F@_1,
                       TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_traces_data(Rest,
                                   0,
...
skip_32_traces_data(<<_:32, Rest/binary>>, Z1, Z2, F@_1,
                    TrUserData) ->
    dfp_read_field_def_traces_data(Rest,
                                   Z1,
                                   Z2,
...
skip_64_traces_data(<<_:64, Rest/binary>>, Z1, Z2, F@_1,
                    TrUserData) ->
    dfp_read_field_def_traces_data(Rest,
                                   Z1,
                                   Z2,
...
dfp_read_field_def_resource_spans(<<18, Rest/binary>>,
                                  Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_resource_spans_scope_spans(Rest,
                                       Z1,
                                       Z2,
                                       F@_1,
                                       F@_2,
                                       F@_3,
                                       TrUserData);
dfp_read_field_def_resource_spans(<<26, Rest/binary>>,
                                  Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_resource_spans_schema_url(Rest,
                                      Z1,
                                      Z2,
                                      F@_1,
                                      F@_2,
...
dfp_read_field_def_resource_spans(<<>>, 0, 0, F@_1, R1,
    ...
    if R1 == '$undef' -> S2;
       true ->
           S2#{scope_spans => lists_reverse(R1, TrUserData)}
    end;
...
d_field_resource_spans_scope_spans(<<1:1, X:7,
                                     Rest/binary>>,
                                   N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_resource_spans_scope_spans(Rest,
                                       ...
                                       F@_3,
                                       TrUserData);
d_field_resource_spans_scope_spans(<<0:1, X:7,
                                     Rest/binary>>,
                                   N, Acc, F@_1, Prev, F@_3, TrUserData) ->
    {NewFValue, RestF} = begin
                             Len = X bsl N + Acc,
                             <<Bs:Len/binary, Rest2/binary>> = Rest,
                             {id(decode_msg_scope_spans(Bs, TrUserData),
                                 TrUserData),
                              Rest2}
                         end,
    dfp_read_field_def_resource_spans(RestF,
...
d_field_resource_spans_schema_url(<<1:1, X:7,
                                    Rest/binary>>,
                                  N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_resource_spans_schema_url(Rest,
                                      ...
                                      F@_3,
                                      TrUserData);
d_field_resource_spans_schema_url(<<0:1, X:7,
                                    Rest/binary>>,
...
decode_msg_scope_spans(Bin, TrUserData) ->
    dfp_read_field_def_scope_spans(Bin,
                                   0,
                                   0,
                                   id('$undef', TrUserData),
                                   id([], TrUserData),
...
dfp_read_field_def_scope_spans(<<10, Rest/binary>>, Z1,
                               Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_scope_spans_scope(Rest,
                              Z1,
                              Z2,
                              F@_1,
                              F@_2,
                              F@_3,
                              TrUserData);
dfp_read_field_def_scope_spans(<<18, Rest/binary>>, Z1,
                               Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_scope_spans_spans(Rest,
                              Z1,
                              Z2,
                              F@_1,
                              F@_2,
                              F@_3,
                              TrUserData);
dfp_read_field_def_scope_spans(<<26, Rest/binary>>, Z1,
                               Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_scope_spans_schema_url(Rest,
                                   Z1,
                                   Z2,
                                   F@_1,
                                   F@_2,
                                   F@_3,
                                   TrUserData);
dfp_read_field_def_scope_spans(<<>>, 0, 0, F@_1, R1,
                               F@_3, TrUserData) ->
    S1 = #{schema_url => F@_3},
    S2 = if F@_1 == '$undef' -> S1;
            true -> S1#{scope => F@_1}
...
dfp_read_field_def_scope_spans(Other, Z1, Z2, F@_1,
                               F@_2, F@_3, TrUserData) ->
    dg_read_field_def_scope_spans(Other,
                                  Z1,
                                  Z2,
                                  F@_1,
                                  F@_2,
...
dg_read_field_def_scope_spans(<<1:1, X:7, Rest/binary>>,
                              N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_scope_spans(Rest,
                                  N + 7,
                                  X bsl N + Acc,
                                  F@_1,
                                  F@_2,
                                  F@_3,
                                  TrUserData);
dg_read_field_def_scope_spans(<<0:1, X:7, Rest/binary>>,
                              N, Acc, F@_1, F@_2, F@_3, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        10 ->
            ...
            case Key band 7 of
                ...
                1 ->
                    skip_64_scope_spans(Rest,
                                        ...
                                        TrUserData);
                2 ->
                    skip_length_delimited_scope_spans(Rest,
                                                      0,
                                                      0,
                                                      F@_1,
                                                      F@_2,
...
dg_read_field_def_scope_spans(<<>>, 0, 0, F@_1, R1,
                              F@_3, TrUserData) ->
    S1 = #{schema_url => F@_3},
    S2 = if F@_1 == '$undef' -> S1;
            true -> S1#{scope => F@_1}
...
d_field_scope_spans_scope(<<1:1, X:7, Rest/binary>>, N,
    ...
    d_field_scope_spans_scope(Rest,
                              ...
                              F@_3,
                              TrUserData);
d_field_scope_spans_scope(<<0:1, X:7, Rest/binary>>, N,
...
d_field_scope_spans_spans(<<1:1, X:7, Rest/binary>>, N,
                          Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_scope_spans_spans(Rest,
                              N + 7,
                              ...
                              F@_3,
                              TrUserData);
d_field_scope_spans_spans(<<0:1, X:7, Rest/binary>>, N,
...
d_field_scope_spans_schema_url(<<1:1, X:7,
                                 Rest/binary>>,
                               N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_scope_spans_schema_url(Rest,
                                   ...
                                   F@_3,
                                   TrUserData);
d_field_scope_spans_schema_url(<<0:1, X:7,
                                 Rest/binary>>,
                               N, Acc, F@_1, F@_2, _, TrUserData) ->
    {NewFValue, RestF} = begin
                             Len = X bsl N + Acc,
...
skip_varint_scope_spans(<<1:1, _:7, Rest/binary>>, Z1,
                        Z2, F@_1, F@_2, F@_3, TrUserData) ->
    skip_varint_scope_spans(Rest,
                            Z1,
                            Z2,
                            ...
                            F@_3,
                            TrUserData);
skip_varint_scope_spans(<<0:1, _:7, Rest/binary>>, Z1,
                        Z2, F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_scope_spans(Rest,
                                   Z1,
                                   Z2,
                                   F@_1,
                                   F@_2,
...
skip_length_delimited_scope_spans(<<1:1, X:7,
                                    Rest/binary>>,
                                  N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    skip_length_delimited_scope_spans(Rest,
                                      ...
                                      F@_3,
                                      TrUserData);
skip_length_delimited_scope_spans(<<0:1, X:7,
                                    Rest/binary>>,
                                  N, Acc, F@_1, F@_2, F@_3, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_scope_spans(Rest2,
                                   0,
                                   0,
                                   F@_1,
                                   F@_2,
...
skip_group_scope_spans(Bin, FNum, Z2, F@_1, F@_2, F@_3,
                       TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_scope_spans(Rest,
                                   0,
...
skip_32_scope_spans(<<_:32, Rest/binary>>, Z1, Z2, F@_1,
                    F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_scope_spans(Rest,
                                   Z1,
                                   Z2,
...
skip_64_scope_spans(<<_:64, Rest/binary>>, Z1, Z2, F@_1,
                    F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_scope_spans(Rest,
                                   Z1,
                                   Z2,
...
dfp_read_field_def_link(<<40, Rest/binary>>, Z1, Z2,
    ...
    d_field_link_dropped_attributes_count(Rest,
                                          ...
                                          F@_6,
                                          TrUserData);
dfp_read_field_def_link(<<53, Rest/binary>>, Z1, Z2,
                        F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) ->
    d_field_link_flags(Rest,
                       Z1,
                       Z2,
                       F@_1,
                       F@_2,
...
d_field_link_flags(<<Value:32/little, Rest/binary>>, Z1,
                   Z2, F@_1, F@_2, F@_3, F@_4, F@_5, _, TrUserData) ->
...
dfp_read_field_def_span(<<>>, 0, 0, F@_1, F@_2, F@_3,
                        F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, R1, F@_11, R2,
                        F@_13, R3, F@_15, F@_16, TrUserData) ->
    S1 = #{trace_id => F@_1, span_id => F@_2,
           trace_state => F@_3, parent_span_id => F@_4,
           flags => F@_5, name => F@_6, kind => F@_7,
           start_time_unix_nano => F@_8,
           end_time_unix_nano => F@_9,
           dropped_attributes_count => F@_11,
           dropped_events_count => F@_13,
           dropped_links_count => F@_15},
    S2 = if R1 == '$undef' -> S1;
            true -> S1#{attributes => lists_reverse(R1, TrUserData)}
         end,
    S3 = if R2 == '$undef' -> S2;
...
d_field_span_flags(<<Value:32/little, Rest/binary>>, Z1,
                   Z2, F@_1, F@_2, F@_3, F@_4, _, F@_6, F@_7, F@_8, F@_9,
                   F@_10, F@_11, F@_12, F@_13, F@_14, F@_15, F@_16,
                   TrUserData) ->
...
d_field_span_status(<<0:1, X:7, Rest/binary>>, N, Acc,
                    F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
                    F@_10, F@_11, F@_12, F@_13, F@_14, F@_15, Prev,
                    TrUserData) ->
    {NewFValue, RestF} = begin
                             Len = X bsl N + Acc,
                             <<Bs:Len/binary, Rest2/binary>> = Rest,
...
decode_msg_status(Bin, TrUserData) ->
    dfp_read_field_def_status(Bin,
                              ...
                              0,
                              id(<<>>, TrUserData),
                              id('STATUS_CODE_UNSET', TrUserData),
                              TrUserData).
...
dfp_read_field_def_status(<<18, Rest/binary>>, Z1, Z2,
    ...
    d_field_status_message(Rest,
                           ...
                           F@_2,
                           TrUserData);
dfp_read_field_def_status(<<24, Rest/binary>>, Z1, Z2,
                          F@_1, F@_2, TrUserData) ->
    ...
    case MsgName of
        ...
        export_trace_partial_success ->
            merge_msg_export_trace_partial_success(Prev,
                                                   ...
                                                   TrUserData);
        traces_data ->
            merge_msg_traces_data(Prev, New, TrUserData);
        resource_spans ->
            merge_msg_resource_spans(Prev, New, TrUserData);
        scope_spans ->
            merge_msg_scope_spans(Prev, New, TrUserData);
...
merge_msg_export_trace_service_response(PMsg, NMsg,
                                        TrUserData) ->
    S1 = #{},
    case {PMsg, NMsg} of
        {#{partial_success := PFpartial_success},
         #{partial_success := NFpartial_success}} ->
            S1#{partial_success =>
                    merge_msg_export_trace_partial_success(PFpartial_success,
                                                           NFpartial_success,
                                                           TrUserData)};
...
merge_msg_export_trace_partial_success(PMsg, NMsg, _) ->
    ...
    S2 = case {PMsg, NMsg} of
             {_, #{rejected_spans := NFrejected_spans}} ->
                 S1#{rejected_spans => NFrejected_spans};
             {#{rejected_spans := PFrejected_spans}, _} ->
                 S1#{rejected_spans => PFrejected_spans};
             _ -> S1
         end,
    case {PMsg, NMsg} of
...
merge_msg_resource_spans(PMsg, NMsg, TrUserData) ->
    ...
    S3 = case {PMsg, NMsg} of
             {#{scope_spans := PFscope_spans},
              #{scope_spans := NFscope_spans}} ->
                 S2#{scope_spans =>
                         'erlang_++'(PFscope_spans, NFscope_spans, TrUserData)};
             {_, #{scope_spans := NFscope_spans}} ->
                 S2#{scope_spans => NFscope_spans};
             {#{scope_spans := PFscope_spans}, _} ->
                 S2#{scope_spans => PFscope_spans};
             {_, _} -> S2
         end,
    case {PMsg, NMsg} of
...
merge_msg_span(PMsg, NMsg, TrUserData) ->
    ...
    S9 = case {PMsg, NMsg} of
             {_,
              #{start_time_unix_nano := NFstart_time_unix_nano}} ->
                 S8#{start_time_unix_nano => NFstart_time_unix_nano};
             {#{start_time_unix_nano := PFstart_time_unix_nano},
              _} ->
                 S8#{start_time_unix_nano => PFstart_time_unix_nano};
             _ -> S8
         end,
    S10 = case {PMsg, NMsg} of
              {_, #{end_time_unix_nano := NFend_time_unix_nano}} ->
                  S9#{end_time_unix_nano => NFend_time_unix_nano};
              {#{end_time_unix_nano := PFend_time_unix_nano}, _} ->
                  S9#{end_time_unix_nano => PFend_time_unix_nano};
              _ -> S9
          end,
              ...
              {#{attributes := PFattributes},
               #{attributes := NFattributes}} ->
                  S10#{attributes =>
                           'erlang_++'(PFattributes, NFattributes, TrUserData)};
              {_, #{attributes := NFattributes}} ->
                  S10#{attributes => NFattributes};
              {#{attributes := PFattributes}, _} ->
                  S10#{attributes => PFattributes};
              {_, _} -> S10
          end,
    ...
    S14 = case {PMsg, NMsg} of
              {_,
               #{dropped_events_count := NFdropped_events_count}} ->
                  S13#{dropped_events_count => NFdropped_events_count};
              {#{dropped_events_count := PFdropped_events_count},
               _} ->
                  S13#{dropped_events_count => PFdropped_events_count};
              _ -> S13
          end,
    ...
    S16 = case {PMsg, NMsg} of
              {_, #{dropped_links_count := NFdropped_links_count}} ->
                  S15#{dropped_links_count => NFdropped_links_count};
              {#{dropped_links_count := PFdropped_links_count}, _} ->
                  S15#{dropped_links_count => PFdropped_links_count};
              _ -> S15
          end,
    case {PMsg, NMsg} of
    ...
    case MsgName of
        ...
        export_trace_service_response ->
            v_msg_export_trace_service_response(Msg,
                                                ...
                                                TrUserData);
        export_trace_partial_success ->
            v_msg_export_trace_partial_success(Msg,
                                               [MsgName],
                                               TrUserData);
        traces_data ->
            v_msg_traces_data(Msg, [MsgName], TrUserData);
        resource_spans ->
            v_msg_resource_spans(Msg, [MsgName], TrUserData);
        scope_spans ->
            v_msg_scope_spans(Msg, [MsgName], TrUserData);
...
v_msg_export_trace_service_response(#{} = M, Path,
    ...
    case M of
        #{partial_success := F1} ->
            v_msg_export_trace_partial_success(F1,
...
v_msg_export_trace_partial_success(#{} = M, Path,
                                   TrUserData) ->
    case M of
        #{rejected_spans := F1} ->
            v_type_int64(F1, [rejected_spans | Path], TrUserData);
        _ -> ok
    end,
    case M of
        #{error_message := F2} ->
    ...
    lists:foreach(fun (rejected_spans) -> ok;
                  ...
                  maps:keys(M)),
    ok;
v_msg_export_trace_partial_success(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields,
                   [] -- maps:keys(M),
                   export_trace_partial_success},
                  M,
                  Path);
v_msg_export_trace_partial_success(X, Path,
                                   _TrUserData) ->
    mk_type_error({expected_msg,
                   export_trace_partial_success},
                  X,
...
v_msg_traces_data(#{} = M, Path, TrUserData) ->
    ...
    lists:foreach(fun (resource_spans) -> ok;
                  ...
                  maps:keys(M)),
    ok;
v_msg_traces_data(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields,
                   [] -- maps:keys(M),
                   traces_data},
                  M,
                  Path);
v_msg_traces_data(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, traces_data}, X, Path).
...
v_msg_resource_spans(#{} = M, Path, TrUserData) ->
    ...
    case M of
        #{scope_spans := F2} ->
            if is_list(F2) ->
                   _ = [v_msg_scope_spans(Elem,
                                          [scope_spans | Path],
                                          TrUserData)
                        || Elem <- F2],
                   ok;
               true ->
                   mk_type_error({invalid_list_of, {msg, scope_spans}},
                                 F2,
                                 [scope_spans | Path])
            end;
        _ -> ok
...
v_msg_scope_spans(#{} = M, Path, TrUserData) ->
    ...
    lists:foreach(fun (scope) -> ok;
                  ...
                  maps:keys(M)),
    ok;
v_msg_scope_spans(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields,
                   [] -- maps:keys(M),
                   scope_spans},
                  M,
                  Path);
v_msg_scope_spans(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, scope_spans}, X, Path).
...
v_msg_link(#{} = M, Path, TrUserData) ->
    ...
    case M of
        #{flags := F6} ->
            v_type_fixed32(F6, [flags | Path], TrUserData);
        _ -> ok
    end,
...
v_msg_span(#{} = M, Path, TrUserData) ->
    ...
    case M of
        #{flags := F5} ->
            v_type_fixed32(F5, [flags | Path], TrUserData);
        _ -> ok
    end,
    case M of
        #{name := F6} ->
    ...
    case M of
        #{kind := F7} ->
            'v_enum_span.SpanKind'(F7, [kind | Path], TrUserData);
        _ -> ok
    end,
    case M of
        #{start_time_unix_nano := F8} ->
    ...
    case M of
        #{status := F16} ->
            v_msg_status(F16, [status | Path], TrUserData);
        _ -> ok
    end,
    lists:foreach(fun (trace_id) -> ok;
                      (span_id) -> ok;
...
'v_enum_span.SpanKind'('SPAN_KIND_UNSPECIFIED', _Path,
                       _TrUserData) ->
    ok;
'v_enum_span.SpanKind'('SPAN_KIND_INTERNAL', _Path,
                       _TrUserData) ->
    ok;
'v_enum_span.SpanKind'('SPAN_KIND_SERVER', _Path,
                       _TrUserData) ->
    ok;
'v_enum_span.SpanKind'('SPAN_KIND_CLIENT', _Path,
                       _TrUserData) ->
    ok;
'v_enum_span.SpanKind'('SPAN_KIND_PRODUCER', _Path,
                       _TrUserData) ->
    ok;
'v_enum_span.SpanKind'('SPAN_KIND_CONSUMER', _Path,
                       _TrUserData) ->
    ok;
...
'v_enum_status.StatusCode'('STATUS_CODE_UNSET', _Path,
                           _TrUserData) ->
    ok;
'v_enum_status.StatusCode'('STATUS_CODE_OK', _Path,
                           _TrUserData) ->
    ok;
'v_enum_status.StatusCode'('STATUS_CODE_ERROR', _Path,
                           _TrUserData) ->
    ok;
    ...
    [{{enum, 'span.SpanKind'},
     ...
     {{enum, 'status.StatusCode'},
      [{'STATUS_CODE_UNSET', 0},
       {'STATUS_CODE_OK', 1},
       {'STATUS_CODE_ERROR', 2}]},
     {{enum, 'opentelemetry.proto.trace.v1.SpanFlags'},
     ...
     {{msg, export_trace_service_response},
      [#{name => partial_success, fnum => 1, rnum => 2,
         type => {msg, export_trace_partial_success},
         occurrence => optional, opts => []}]},
     {{msg, export_trace_partial_success},
      [#{name => rejected_spans, fnum => 1, rnum => 2,
     ...
     {{msg, resource_spans},
      [#{name => resource, fnum => 1, rnum => 2,
         ...
         opts => []},
       #{name => scope_spans, fnum => 2, rnum => 3,
         type => {msg, scope_spans}, occurrence => repeated,
         opts => []},
     ...
     {{msg, link},
      [#{name => trace_id, fnum => 1, rnum => 2,
       ...
       #{name => dropped_attributes_count, fnum => 5,
         ...
         opts => []},
       #{name => flags, fnum => 6, rnum => 7, type => fixed32,
         occurrence => optional, opts => []}]},
     {{msg, span},
      [#{name => trace_id, fnum => 1, rnum => 2,
         type => bytes, occurrence => optional, opts => []},
       ...
       #{name => parent_span_id, fnum => 4, rnum => 5,
         type => bytes, occurrence => optional, opts => []},
       #{name => flags, fnum => 16, rnum => 6, type => fixed32,
         occurrence => optional, opts => []},
       #{name => name, fnum => 5, rnum => 7, type => string,
         occurrence => optional, opts => []},
       #{name => kind, fnum => 6, rnum => 8,
         type => {enum, 'span.SpanKind'}, occurrence => optional,
         opts => []},
       #{name => start_time_unix_nano, fnum => 7, rnum => 9,
         type => fixed64, occurrence => optional, opts => []},
       #{name => end_time_unix_nano, fnum => 8, rnum => 10,
         type => fixed64, occurrence => optional, opts => []},
       #{name => attributes, fnum => 9, rnum => 11,
         type => {msg, key_value}, occurrence => repeated,
         opts => []},
       #{name => dropped_attributes_count, fnum => 10,
         rnum => 12, type => uint32, occurrence => optional,
         opts => []},
       #{name => events, fnum => 11, rnum => 13,
         type => {msg, event}, occurrence => repeated,
         opts => []},
       #{name => dropped_events_count, fnum => 12, rnum => 14,
         type => uint32, occurrence => optional, opts => []},
       #{name => links, fnum => 13, rnum => 15,
         type => {msg, link}, occurrence => repeated,
         opts => []},
       #{name => dropped_links_count, fnum => 14, rnum => 16,
         type => uint32, occurrence => optional, opts => []},
       #{name => status, fnum => 15, rnum => 17,
         type => {msg, status}, occurrence => optional,
         opts => []}]},
     {{msg, status},
      [#{name => message, fnum => 2, rnum => 2,
         type => string, occurrence => optional, opts => []},
       #{name => code, fnum => 3, rnum => 3,
...
find_msg_def(export_trace_service_response) ->
    [#{name => partial_success, fnum => 1, rnum => 2,
       type => {msg, export_trace_partial_success},
       occurrence => optional, opts => []}];
find_msg_def(export_trace_partial_success) ->
    [#{name => rejected_spans, fnum => 1, rnum => 2,
       type => int64, occurrence => optional, opts => []},
     #{name => error_message, fnum => 2, rnum => 3,
       type => string, occurrence => optional, opts => []}];
find_msg_def(traces_data) ->
    [#{name => resource_spans, fnum => 1, rnum => 2,
       type => {msg, resource_spans}, occurrence => repeated,
       opts => []}];
...
find_enum_def('status.StatusCode') ->
    [{'STATUS_CODE_UNSET', 0},
     {'STATUS_CODE_OK', 1},
     {'STATUS_CODE_ERROR', 2}];
find_enum_def('opentelemetry.proto.trace.v1.SpanFlags') ->
    [{'SPAN_FLAGS_DO_NOT_USE', 0},
     {'SPAN_FLAGS_TRACE_FLAGS_MASK', 255}];
...
enum_symbol_by_value('opentelemetry.proto.trace.v1.SpanFlags',
                     Value) ->
    'enum_symbol_by_value_opentelemetry.proto.trace.v1.SpanFlags'(Value).
...
enum_value_by_symbol('opentelemetry.proto.trace.v1.SpanFlags',
                     Sym) ->
    'enum_value_by_symbol_opentelemetry.proto.trace.v1.SpanFlags'(Sym).


'enum_symbol_by_value_span.SpanKind'(0) ->
    'SPAN_KIND_UNSPECIFIED';
'enum_symbol_by_value_span.SpanKind'(1) ->
    'SPAN_KIND_INTERNAL';
'enum_symbol_by_value_span.SpanKind'(2) ->
    'SPAN_KIND_SERVER';
'enum_symbol_by_value_span.SpanKind'(3) ->
    'SPAN_KIND_CLIENT';
'enum_symbol_by_value_span.SpanKind'(4) ->
    'SPAN_KIND_PRODUCER';
'enum_symbol_by_value_span.SpanKind'(5) ->
    'SPAN_KIND_CONSUMER'.


'enum_value_by_symbol_span.SpanKind'('SPAN_KIND_UNSPECIFIED') ->
    0;
'enum_value_by_symbol_span.SpanKind'('SPAN_KIND_INTERNAL') ->
    1;
'enum_value_by_symbol_span.SpanKind'('SPAN_KIND_SERVER') ->
    2;
'enum_value_by_symbol_span.SpanKind'('SPAN_KIND_CLIENT') ->
    3;
'enum_value_by_symbol_span.SpanKind'('SPAN_KIND_PRODUCER') ->
    4;
'enum_value_by_symbol_span.SpanKind'('SPAN_KIND_CONSUMER') ->
    5.

'enum_symbol_by_value_status.StatusCode'(0) ->
    'STATUS_CODE_UNSET';
'enum_symbol_by_value_status.StatusCode'(1) ->
    'STATUS_CODE_OK';
'enum_symbol_by_value_status.StatusCode'(2) ->
    'STATUS_CODE_ERROR'.


'enum_value_by_symbol_status.StatusCode'('STATUS_CODE_UNSET') ->
    0;
'enum_value_by_symbol_status.StatusCode'('STATUS_CODE_OK') ->
    1;
'enum_value_by_symbol_status.StatusCode'('STATUS_CODE_ERROR') ->
    2.

'enum_symbol_by_value_opentelemetry.proto.trace.v1.SpanFlags'(0) ->
    'SPAN_FLAGS_DO_NOT_USE';
'enum_symbol_by_value_opentelemetry.proto.trace.v1.SpanFlags'(255) ->
    'SPAN_FLAGS_TRACE_FLAGS_MASK'.


'enum_value_by_symbol_opentelemetry.proto.trace.v1.SpanFlags'('SPAN_FLAGS_DO_NOT_USE') ->
    0;
'enum_value_by_symbol_opentelemetry.proto.trace.v1.SpanFlags'('SPAN_FLAGS_TRACE_FLAGS_MASK') ->
    255.
...
get_rpc_names('opentelemetry.proto.collector.trace.v1.TraceService') ->
    ['Export'];
...
'find_rpc_def_opentelemetry.proto.collector.trace.v1.TraceService'('Export') ->
    #{name => 'Export',
      input => export_trace_service_request,
      output => export_trace_service_response,
      input_stream => false, output_stream => false,
      opts => []};
'find_rpc_def_opentelemetry.proto.collector.trace.v1.TraceService'(_) ->
    error.
...
fqbin_to_service_name(<<"opentelemetry.proto.collector.trace.v1.TraceService">>) ->
    'opentelemetry.proto.collector.trace.v1.TraceService';
...
service_name_to_fqbin('opentelemetry.proto.collector.trace.v1.TraceService') ->
    <<"opentelemetry.proto.collector.trace.v1.TraceService">>;
...
%% name, as atoms.
fqbins_to_service_and_rpc_name(<<"opentelemetry.proto.collector.trace.v1.TraceService">>, <<"Export">>) ->
    {'opentelemetry.proto.collector.trace.v1.TraceService',
     'Export'};
...
fqbin_to_msg_name(<<"opentelemetry.proto.collector.trace.v1.ExportTraceServiceRequest">>) ->
    export_trace_service_request;
fqbin_to_msg_name(<<"opentelemetry.proto.collector.trace.v1.ExportTraceServiceResponse">>) ->
    export_trace_service_response;
fqbin_to_msg_name(<<"opentelemetry.proto.collector.trace.v1.ExportTracePartialSuccess">>) ->
    export_trace_partial_success;
...
msg_name_to_fqbin(export_trace_service_request) ->
    <<"opentelemetry.proto.collector.trace.v1.ExportTraceServiceRequest">>;
msg_name_to_fqbin(export_trace_service_response) ->
    <<"opentelemetry.proto.collector.trace.v1.ExportTraceServiceResponse">>;
msg_name_to_fqbin(export_trace_partial_success) ->
...
fqbin_to_enum_name(<<"opentelemetry.proto.trace.v1.SpanFlags">>) ->
    'opentelemetry.proto.trace.v1.SpanFlags';
...
enum_name_to_fqbin('opentelemetry.proto.trace.v1.SpanFlags') ->
    <<"opentelemetry.proto.trace.v1.SpanFlags">>;
...
%% functions.
get_all_proto_names() ->
    ["trace_service", "trace", "common", "resource"].


get_msg_containment("trace_service") ->
    [export_trace_partial_success,
     export_trace_service_request,
     export_trace_service_response];
...
get_pkg_containment("trace_service") ->
    'opentelemetry.proto.collector.trace.v1';
...
get_service_containment("trace_service") ->
    ['opentelemetry.proto.collector.trace.v1.TraceService'];
...
get_rpc_containment("trace_service") ->
    [{'opentelemetry.proto.collector.trace.v1.TraceService',
      'Export'}];
...
get_proto_by_msg_name_as_fqbin(<<"opentelemetry.proto.collector.trace.v1.ExportTracePartialSuccess">>) ->
    "trace_service";
...
get_proto_by_service_name_as_fqbin(<<"opentelemetry.proto.collector.trace.v1.TraceService">>) ->
    "trace_service";
...
get_protos_by_pkg_name_as_fqbin(<<"opentelemetry.proto.collector.trace.v1">>) ->
    ["trace_service"];
